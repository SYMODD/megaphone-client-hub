...
import { LogOut, User, Shield, Users, Eye, Menu } from "lucide-react";
      ...
      <div className="container mx-auto px-3 sm:px-4 py-3 sm:py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2 sm:space-x-4">
            <h1 className="text-lg sm:text-2xl font-bold text-slate-800">Sud Megaphone</h1>
            <Badge variant="secondary" className="px-1 py-0.5 text-xs sm:px-2 sm:py-1 hidden sm:inline-flex">
              Client Manager
            </Badge>
          </div>
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            {profile ? (
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                {/* Mobile version - show only role indicator */}
