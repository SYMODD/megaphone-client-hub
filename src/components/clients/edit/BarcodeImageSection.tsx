...
export const BarcodeImageSection = ({ client }: BarcodeImageSectionProps) => {
  ...
  console.log('IMAGE CHECK:', { hasBarcode, hasBarcodeImage });
          ...
          {hasBarcodeImage ? (
              ...
              <div className="flex items-center justify-center p-4 bg-gray-50 border rounded-lg min-h-[120px]">
                <img 
                  ...
                  onError={(e) => {
                    ...
                    if (parent) {
                      parent.innerHTML = `<div class="text-center text-red-600">❌ Erreur chargement image</div>`;
                    }
                  }}
                  onLoad={() => {
            ...
            <div className="p-4 bg-gray-50 border rounded-lg text-center">
              <p className="text-sm text-gray-600">
                {hasBarcode ? "Aucune image sauvegardée" : "Aucun code-barres"}
              </p>
            </div>
          )}
        </div>
